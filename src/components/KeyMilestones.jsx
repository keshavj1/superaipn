...
export default function KeyMilestones() {
    ...
    return (
        <section ref={sectionRef} className="relative py-28 overflow-hidden" style={{ background: "var(--surface-section)" }}>
            {/* Subtle grid pattern */}
            ...
            <div className="max-w-5xl mx-auto px-6 relative z-10">
                {/* Header */}
                <div
                    className="text-center mb-16 max-w-3xl mx-auto  section_sects"
                    style={{
                        opacity: visible ? 1 : 0,
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className={`flex-1 ${isLeft ? "md:text-right" : "md:text-left"} pl-14 md:pl-0`}>
                                        <div
                                            className="card1sect2 inline-block rounded-xl p-6 hover:border-amber-500/40 transition-all duration-500 group-hover:-translate-y-1.5 group-hover:scale-[1.02] group-hover:shadow-[0_10px_30px_-10px_rgba(245,158,11,0.2)] bg-white/[0.02]"
                                        >
                                    ...
                                    <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-[#0a0b10] border-2 border-purple-500/30 group-hover:border-amber-500/80 flex items-center justify-center text-xl z-10 flex-shrink-0 transition-colors duration-500 group-hover:shadow-[0_0_20px_rgba(245,158,11,0.4)]">
                                        <span className="relative z-10 transition-transform duration-500 group-hover:scale-125">{m.icon}   <img
                                            src={m.image}
                                            alt=""
